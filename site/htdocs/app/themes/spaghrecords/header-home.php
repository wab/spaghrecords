	...
	<div id="page" class="container">
		<header id="masthead" class="site-header" role="banner">
            ...
            <div class="col-xs-12 col-sm-4 col-md-3 col-lg-2">
                ...
                <img src="<?php bloginfo('template_directory'); ?>/images/logo_spaghrecords.jpg" alt="Spagh records" />
            </div>
            <div class="hidden-xs col-sm-8 col-md-9 col-lg-10"><?php get_sidebar(); ?></div>
		</header><!-- #masthead -->
